...
function* warnNonPremium() {
    ...
    yield put(
        showToast(
            ...
            "To create parties and play music on this app, you need to have a 'Spotify Premium' account. Please login again using a premium account if you want to host parties.",
            10000,
        ),
    );
}
